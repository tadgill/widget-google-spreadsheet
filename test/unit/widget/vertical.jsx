...
describe("<Vertical />", function() {
  ...
  beforeEach(function () {
    var component = <Vertical onDone={onDone} scroll={scroll} data={data} align={align} class={className} totalCols={totalCols} rowHeight={rowHeight} width={width} height={height} columnFormats={columnFormats} />;
